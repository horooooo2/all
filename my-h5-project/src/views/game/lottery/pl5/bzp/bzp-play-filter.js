...
export const PLAY_FILTER_TREE = [
  ...
  { id: 'hs', label: '后四', subs: [{ id: 'hs-zx', label: '后四组4' }, { id: 'hs-zhi', label: '后四直 }] },
  ...
  { id: 'q2', label: '前二', subs: [{ id: 'q2-zhi', label: '前二直 }, { id: 'q2-z', label: '前二组 }] },
  { id: 'dwd', label: '定位, subs: [{ id: 'dwd-wx', label: '五星定位' }] },
