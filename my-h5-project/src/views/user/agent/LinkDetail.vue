  ...
  <div class="agent-subpage link-detail-page">
    ...
    <div class="ld-head">
      ...
      <div class="ld-url-row">
        ...
        <button type="button" class="ld-copy" @click="copyText(linkUrl)">复制</button>
      </div>
    </div>
    ...
    <div class="ld-section">
      <div class="ld-table">
        <div class="ld-table-head">
          <span class="ld-th">类型</span>
          <span class="ld-th">最低有效投注</span>
          <span class="ld-th ld-th--right">返水比例%</span>
        </div>
...
const linkTitle = ref('该链接赚取返水为0')
const linkUrl = ref('https://web.bmdeby.com/app/home')

// mock: 只用于展示结构，后续对接接口替换
const gameRows = ref([
  { id: 'el_1', type: '电子', minBet: '¥1', rate: '0.8%' },
  { id: 'el_2', type: '投注1元起', minBet: '¥1', rate: '0.8%' },
  { id: 'el_3', type: '投注50万元起', minBet: '¥500000', rate: '0.8%' },
  { id: 'el_4', type: '投注200万元起', minBet: '¥2000000', rate: '0.9%' },
  { id: 'el_5', type: '投注500万元起', minBet: '¥5000000', rate: '1.0%' }
])

const lotteryExpanded = ref(true)
const lotteryRows = ref([
  { id: 'l_1', type: '个位球', minBet: '¥0', rate: '0%' },
  { id: 'l_2', type: '和值', minBet: '¥0', rate: '0.4%' },
  { id: 'l_3', type: '个十', minBet: '¥0', rate: '0.4%' },
  { id: 'l_4', type: '特码', minBet: '¥0', rate: '0.4%' },
  { id: 'l_5', type: '龙虎和 - 球二球', minBet: '¥0', rate: '0.4%' }
])
